...
<script src="//api-maps.yandex.ru/2.1/?lang={$smarty.const.CART_LANGUAGE}&key={$settings.adama_store_locator.yandex_key}" type="text/javascript"></script>
{script src="/js/addons/adama_store_locator/yandex.js"}
