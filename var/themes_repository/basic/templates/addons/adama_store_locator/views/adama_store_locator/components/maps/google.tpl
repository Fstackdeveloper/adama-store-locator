...
<script type="text/javascript">
    (function(_, $) {
        var options = {
            ...
            'language': '{$smarty.const.CART_LANGUAGE|fn_adama_store_locator_google_langs}',
            'storeData': [
            {foreach from=$adama_store_locations item="loc" name="st_loc_foreach" key="key"}
            {
                'adama_store_location_id' : '{$loc.adama_store_location_id}',
